    ...
    >
      ...
      <div className="standard-frame relative z-10">
        <SectionTitle
          ...
          subtitle="Trước 1930, dân tộc Việt Nam đã đi qua nhiều con đường cứu nước khác nhau. Mỗi phong trào đều để lại dấu ấn lớn, nhưng cũng cho thấy giới hạn của những khuynh hướng cũ."
          light
        />
